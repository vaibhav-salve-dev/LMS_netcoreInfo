...
export default function CourseCard({ course, variant = 'default', onContinue }) {
    ...
    return (
      <div className="card overflow-hidden group hover:shadow-card transition-all duration-300 flex flex-col sm:flex-row">
        ...
        <div className="p-5 flex-1 flex flex-col justify-between">
          <div>
            <h3 className="font-semibold text-ink-900 text-base line-clamp-1">
              {course.title}
            </h3>
            ...
            <div className="flex items-center gap-3 mt-2 text-xs text-ink-500">
              ...
              <span className="flex items-center gap-1">
                <Play size={12} /> {course.completedLessons}/{course.totalLessons} lessons
              </span>
            </div>
          </div>
          <div className="mt-4">
  ...
  return (
    <div
      className="card overflow-hidden group hover:shadow-card transition-all duration-300 flex flex-col cursor-pointer"
